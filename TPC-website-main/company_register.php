...
<header>
	...
	<form action="" method="post">
        ...
        <br><br>Already a user? <a href="companylogin.php" class="button">Login</a>
...
$sql = "INSERT INTO Company (company_name, email, password, job_description, role_offered, minimum_cpi, preferred_department, essential_skills, salary_package, mode_of_interview, recruiting_since)
